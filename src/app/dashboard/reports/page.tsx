    ...
    return (
        <div className="space-y-6 animate-in fade-in zoom-in duration-500">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold text-[var(--foreground)]">Intelligence Reports</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                    <Card key={i} className="hover:border-primary/50 transition-colors cursor-pointer group">
                        ...
                        <h3 className="text-lg font-bold text-[var(--foreground)] mb-2 group-hover:text-primary transition-colors">Sector 7 Analysis: Threat Level {i % 2 === 0 ? 'High' : 'Medium'}</h3>

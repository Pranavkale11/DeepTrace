            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card className="p-6">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between p-4 bg-[var(--surface-highlight)] rounded-lg border border-[var(--border)] hover:border-white/10 transition-colors">
                            <div>
                                <p className="text-[var(--foreground)] font-medium mb-1">Live Network Scanners</p>
                        ...
                        <div className="flex items-center justify-between p-4 bg-[var(--surface-highlight)] rounded-lg border border-[var(--border)] hover:border-white/10 transition-colors">
                            <div>
                                <p className="text-[var(--foreground)] font-medium mb-1">Deepfake Detection Engine</p>
                ...
                <div className="space-y-6">
                    ...
                    <Card className="p-6 relative overflow-hidden">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm relative z-10">
                            <div className="p-3 bg-[var(--surface-highlight)] rounded border border-[var(--border)]">
                                <p className="text-gray-500 text-xs uppercase mb-1">Version</p>
                                <p className="text-[var(--foreground)] font-mono">v2.0.4-alpha</p>
                            </div>
                            <div className="p-3 bg-[var(--surface-highlight)] rounded border border-[var(--border)]">
                            ...
                            <div className="p-3 bg-[var(--surface-highlight)] rounded border border-[var(--border)]">
                                ...
                                <p className="text-[var(--foreground)] font-mono">2026-02-01</p>
                            </div>
                        </div>
                    </Card>
                </div>
